    ...
    <div class="header">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown"> <span class="user-img"><img class="rounded-circle" src="{{ Asset('Assets/admin/img/profiles/avatar-01.jpg') }}" width="31" alt="Soeng Souy"></span> </a>
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu"> <a href="#"><i class="fas fa-suitcase"></i> <span> Data Barang </span> <span class="menu-arrow"></span></a>
                        <ul class="submenu_class" style="display: none;">
                            <li><a href="{{ route('barang') }}"> Barang </a></li>
                            <li><a href="edit-booking.html"> Kategori </a></li>
                        </ul>
                    </li>
